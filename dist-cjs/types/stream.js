...
exports.withStreamEventMeta = withStreamEventMeta;
exports.sequenceStreamEvent = sequenceStreamEvent;
exports.adaptLegacyEvents = adaptLegacyEvents;
exports.adaptLegacyEvent = adaptLegacyEvent;
...
function withStreamEventMeta(event, meta) {
    return {
        ...event,
...
function sequenceStreamEvent(event, seq, ts = new Date().toISOString()) {
    return withStreamEventMeta(event, { seq: event.seq ?? seq, ts: event.ts ?? ts });
}
function adaptLegacyEvents(raw, context) {
...
function adaptLegacyEvent(raw, context) {
